...
describe ProductsController, type: :controller do
	...
	before do
		...
		@product1 = FactoryGirl.create(:product, name: "bike1", description: "fast bike", colour: "green", price: "100")
		@product2 = FactoryGirl.create(:product, name: "bike2", description: "good bike", colour: "blue", price: "200")
		@product3 = FactoryGirl.create(:product, name: "bike3", description: "new bike", colour: "red", price: "400")
		@product4 = FactoryGirl.create(:product, name: "bike4", description: "amazing bike", colour: "black", price: "700")
	...
	describe 'PATCH #update' do
		context 'when a product is updated' do
			it 'saves the product to the database' do
				before = Product.all.length
				patch :update, params: { id: @product1.id, product: {name: "bike1"} }
				after = Product.all.length
				expect(response.status).to eq 302
				expect(response).to redirect_to('@product')
				expect(after).to eq before
